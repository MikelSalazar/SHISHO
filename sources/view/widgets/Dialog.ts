...
import { JsonExporter } from "../../data/exporters/JsonExporter";
import { JsonImporter } from "../../data/importers/JsonImporter";
...
export class Dialog extends Widget {
	...
	static create(type: string, layer: Layer, title: string = null, 
		...
		case "Info": return new Dialog("Info", layer, title, 
